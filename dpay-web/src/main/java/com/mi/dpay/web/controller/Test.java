...
public class Test {
    ...
    public static String getSignature(Map<String, String> params,
        ...
        String client_secret = "12F0669F6D7D9D07962012D09B8170D9";//WebUtils.getConfigProperties("client_secret");
    ...
    public static String sendGetHttps(String url, Map<String, String> params,
        ...
        HttpsURLConnection con = HttpsURLConnection.class.cast(requestUrl.openConnection());
    ...
    public static void main(String args[]) {
        try {
            String url = "https://imail.wo.cn:7443/AuthServer/oauth/validateToken";
            Map<String, String> params = new HashMap<String, String>();
            Map<String, String> header = new HashMap<String, String>();
            long timestamp = System.currentTimeMillis();
            params.put("access_token", "T_BGPEflVnSkfaszJQSMTRS2rc5apG94A6");
            params.put("timestamp", timestamp + "");
            ...
            header.put("Authorization", "WO_MAIL_SP_WOCLOUD:" + sign);
