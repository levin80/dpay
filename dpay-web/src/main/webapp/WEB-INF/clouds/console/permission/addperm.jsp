...
<div class="box box-info">
  ...
  <!-- form start -->
  <form class="form-horizontal" id="form1" name="form1"  action="${base}/permission/perm/addPerm.do" method="post">
    <div class="box-body">
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <div class="input-group"> <span class="input-group-addon"><i class="fa fa-list"></i></span> 
            <ui:select name="permUpid" list="listperm" rootId="0" defaultvalue="0" defaulttext="流量充值平台"/>
          </div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <div class="input-group"> <span class="input-group-addon"><i class="fa fa-cubes"></i></span>
            <input type="text" class="form-control" id="password" name="permName"  placeholder="function name">
          </div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <div class="input-group"> <span class="input-group-addon"><i class="fa fa-link"></i></span>
            <input type="text" class="form-control" id="permUrl" name="email" placeholder="function url">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6" style="margin-top: 5px;">
          <label>
          <input type="radio" name="permUse" value="1" checked="checked" class="minimal" checked>启用 </label>
          <label>
          <input type="radio" name="permUse" value="0"  class="minimal">停用 </label>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <div class="input-group"> <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
            <textarea class="form-control" rows="4" id="permNote" name="permNote" placeholder="Enter ..."></textarea>
          </div>
        </div>
      </div>
    </div>
