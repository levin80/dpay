  ...
  <div class="box-body">
    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      <div class="row">
        <div class="col-sm-6">
          <div class="btn-group">
                      <button type="button" class="btn btn-default" onclick="javascript:window.location.href='${base}/permission/role/perAddRole.do'"><i class="fa fa-plus" style="margin-right: 3px;"></i>新增</button>
                      <button type="button" class="btn btn-default" onclick="editrole();"><i class="fa fa-edit" style="margin-right: 3px;"></i>编辑</button>
                      <button type="button" class="btn btn-default" onclick="deleterole();"><i class="fa fa-trash" style="margin-right: 3px;"></i>删除</button>
                      <button type="button" class="btn btn-default" ><i class="fa fa-certificate" style="margin-right: 3px;"></i>分配权限</button>
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            <thead>
              <tr role="row">
                ...
                <th rowspan="1" colspan="1">角色描述</th>
...
var table;  
  $(function () {
	  ...
	  table = $('#example1').DataTable({
          ...
          "ajax": {  
              "url": "${base}/permission/role/listRole.do",
              "type": "POST"
           },
  ...
  function editrole(){
	  ...
	  window.location.href="${base}/permission/role/getRole.do?id="+id;
  }
  //删除
  function deleterole(){
	  var arr = table.rows({ selected: true });
       	...
       	success:function(responseText){
          	var result=eval("("+responseText+")");
           	if(result._status=="true"){
      			document.location = "${base}/permission/role/listpage.do";
           	}else{
           		alert(result._mes);
           	}
      	}
