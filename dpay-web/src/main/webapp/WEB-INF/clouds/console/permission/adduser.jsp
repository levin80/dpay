      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <div class="input-group"> <span class="input-group-addon" style="padding-right: 16px;padding-left: 16px;"><i class="fa fa-dollar"></i></span>
            <input type="text" class="form-control" name="realRate" placeholder="百分之一为单位，填1表示0.01%">
          </div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-6" style="margin-top: 5px;">
          <label>
          <input type="radio" name="gender" class="minimal" value="1" checked="checked" >男 </label>
          <label>
          <input type="radio" name="gender" class="minimal" value="0">女 </label>
        </div>
      </div>
      <div class="form-group">
...
<!--           <label><input type="checkbox" class="minimal">超级管理员 </label> -->
    ...
    <div class="box-footer">
      ...
      <button type="button" class="btn btn-default pull-right" style="margin-right: 10px;" onclick="javascript:window.location.href='${base}/permission/user/listpage.do'">取消</button>
    </div>
    <!-- /.box-footer -->
  </form>
