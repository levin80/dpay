  ...
  <div class="box-body">
    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      <div class="row">
        <div class="col-sm-6">
          <div class="btn-group">
             <button type="button" class="btn btn-default" onclick="javascript:window.location.href='${base}/permission/user/adduserpage.do'"><i class="fa fa-plus" style="margin-right: 3px;"></i>新增</button>
             <button type="button" class="btn btn-default" onclick="viewuser();"><i class="fa fa-edit" style="margin-right: 3px;"></i>查看</button>
             <button type="button" class="btn btn-default" onclick="edituser();"><i class="fa fa-edit" style="margin-right: 3px;"></i>编辑</button>
             <button type="button" class="btn btn-default" onclick="deleteuser();"><i class="fa fa-trash" style="margin-right: 3px;"></i>删除</button>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            <thead>
              <tr role="row">
                ...
                <th rowspan="1" colspan="1">一级代理名称</th>
                <th rowspan="1" colspan="1">代理商编号</th>
                <th rowspan="1" colspan="1">代理商名称</th>
                <th rowspan="1" colspan="1">账户余额(元)</th>
                <th rowspan="1" colspan="1">赠送余额(元)</th> 
...
//编辑
  function viewuser(){
	  ...
	  window.location.href="${base}/agent/viewUser.do?id="+id;
  }
  ...
  function deleteuser(){
	  ...
	  var id = table.rows({ selected: true }).data()[0][1]; 
	  window.location.href="${base}/permission/user/deleteUserById.do?id="+id;
  }
