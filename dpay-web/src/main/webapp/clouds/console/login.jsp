...
<script type='text/javascript'>
			...
			complete:function(data){
				...
				if(obj.result=="true" ||obj.result== true){
					...
					if(referer != null && referer != ""){
					    ...
					    window.location.href = getRootPath() + "/clouds/console/main.do";
					}
				}
    ...
    function test(){
   	 ...
   	 $.ajax({
            ...
            data:{"fileName":"1.txt","fileDataNumber":"123"},
...
<div class="panel">
  <div class="login">
    ...
    <form id="form">
      ...
      <input class="loginbt" type="button" name="submit" onclick="login();" value="登录"/>
