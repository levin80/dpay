...
<head>
    <title>访问被拒绝</title>
    <meta name="heading" content="访问被拒绝"/>
    <style type="text/css">
		...
		.errBack{margin:0 auto;width:950px;height:415px;background:url(<c:url value="/clouds/console/res/imgs/err_403.gif"/>) no-repeat center 35px}
