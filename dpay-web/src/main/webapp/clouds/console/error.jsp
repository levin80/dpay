...
<head>
    <title>系统错误</title>
    <meta name="heading" content="页面未找到"/>
...
<div class="bx2 errorPage">
    ...
    <%--<dd>您可以：<p>1、检查刚才的输入；<br>2、稍后再试&nbsp;或&nbsp;联系客服电话&nbsp;<var>10086</var>；<br>3、返回&nbsp;<c:url value="/ecps/manager/main.do" var="mainURL" /><a href="${mainURL}" title="主菜单">主菜单</a>。</p></dd>--%>
    </dl>
</div>
</body>
