 ...
 */
public class HbRole extends BaseBean implements Serializable {
	...
	public HbRole(Long id, String roleId, String name, String description,
			int priority, String isSuper, List<String> perms, int status,
			Long areaId, String areaName, String areaCode) {
		super();
		this.id = id;
		this.roleId = roleId;
		this.name = name;
